...
public class BookTheShow {
	static String[] XLReader() throws IOException, InterruptedException, AWTException
	{
		File loc = new File("C:\\Users\\Admin\\OneDrive\\Desktop\\New folder (2)\\maven\\Excel\\ShowBook.xlsx");
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\Admin\\OneDrive\\Desktop\\New folder (2)\\maven\\driver\\chromedriver.exe");
